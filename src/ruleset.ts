export class RuleSet {
  ...
  public ruleSet(path: string | number | null | undefined): RuleSet {
    ...
    const pathNr: number = typeof path === "string" ? parseInt(path, 10) : path;
    ...
    if (typeof path === "string" && path.indexOf(".") >= 0) {
      try {
        ...
        return this.getChild(pos).ruleSet(
  ...
  public cloneRuleSet(
    ...
    const copy = new RuleSet(
      name === undefined || name == null || name === "" ? this._name : name,
      desc === undefined || desc == null || desc === "" ? this._desc : desc,
      anz === undefined || anz == null || anz === "" ? this._anz : anz
    );
